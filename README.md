...
- **Advanced feature extraction techniques**: DCT, FFT, Wavelet Transforms
- **Explainable AI** with LIME for transparent decision-making
- **Robust generalization** across diverse datasets and image complexities
